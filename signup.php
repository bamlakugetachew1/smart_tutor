...
$client->setRedirectUri('http://localhost/tutors/Anyar/signup.php');
...
if(isset($_GET['code'])):
    ...
    if(!isset($token["error"])){
        ...
        if(mysqli_num_rows($get_user) > 0){
            ...
            $value = "YOU HAVE ALERADY REGISTRED SIGN IN PLEASE";
...
<?php
 ...
 if(isset($_POST['signup'])){
  ...
  if(empty($username) || empty($email) || empty($password)){
    ...
    $value = "FIELDS SHOULD NOT BE EMPITY";
    echo "<p style='color:red;text-align:center;font-weight:bold;font-size:20px;'>" . $value . "</p>";
  ...
  $get_user = mysqli_query($db_connection, "SELECT * FROM normal WHERE email='$email'  LIMIT 1");
  if(mysqli_num_rows($get_user) > 0){
	 ...
	 $value = "YOU HAVE ALERADY REGISTRED SIGN IN PLEASE";
	  echo "<p style='color:red;text-align:center;font-weight:bold;font-size:20px;'>" . $value . "</p>";
       ...
       $insert = mysqli_query($db_connection, "INSERT INTO normal (username, email, password) 
		...
		<div class="screen__content">
			...
			<div class="login__field">
              ...
              <i class="fa fa-google fa-fw"></i> signup with Google
				...
				<button class="button login__submit" name="signup">
                ...
                <p>
                 <a href="login.php" id="signup">Alerady Registred?sign in</a>	
                 </p><br>
